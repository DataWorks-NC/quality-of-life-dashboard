...
test('csvToJsonTransform properly transforms arrays', () => {
  const testCSVArray = [{
    id: '370630001011',
    y_2013: 3,
    y_2014: 2,
...
test('new format CSV to json throws errors with bad data', () => {
...
test('new format CSV to json transform works properly', () => {
  const testCSVArray = [
    {
      fips: '370630001011',
      year: 2013,
