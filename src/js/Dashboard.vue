  ...
  <div class="mdl-layout__content" :class="printMode ? 'print' : ''" id="mdl-main-frame">
    <div v-if="!printMode">
      ...
      <div class="mdl-grid demo-cards">
        <div v-if="config.siteConfig && config.siteConfig.contactForm" class="mdl-typography--text-center mdl-color--white mdl-shadow--2dp mdl-cell mdl-cell--4-col mdl-cell--12-col-tablet comment-container">
