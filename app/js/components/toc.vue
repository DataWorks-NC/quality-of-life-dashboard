<template lang="html">
    <div id="toc" v-if="sharedState.metric.config" class="top left">
        <div>
            ...
            <div class="legend">
                <svg  v-if="sharedState.breaks" xmlns="https://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" viewBox="0 0 248.4 39.2" id="maplegend" role="img" aria-labelledby="svgTitle">
...
export default {
    ...
    methods: {
      ...
      selectBreak: function(n) {
        ...
        replaceState(this.sharedState.metricId, this.sharedState.selected, this.sharedState.geography.id);
      },
